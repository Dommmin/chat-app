<template>
    ...
    <div v-if="isShow" class="z-10 w-full bg-base-200">
        ...
        >
            <div class="flex flex-col justify-center space-y-4">
                <Link :href="route('chats.index')" class="flex pl-2 justify-center items-center pt-2 hover:bg-secondary/90 bg-secondary text-white p-4">
    ...
    >
        ...
        >
            ...
            <div class="flex-grow overflow-auto p-4" style="height: calc(100vh - 126px); overflow-y: auto; scrollbar-width: thin;">
                <slot />
            </div>
