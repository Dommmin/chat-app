           ...
           <div class="fixed bottom-0 left-0 top-0 flex h-full w-full flex-col border-r border-neutral-200 md:w-[300px] lg:w-[400px]">
            <div class="flex flex-col justify-center space-y-4">
               ...
               <div
                  ...
                  style="height: calc(100vh - 260px); overflow-y: auto; scrollbar-width: thin"
               >
                  ...
                  >
                     ...
                     <div class="col-span-4">
                        <div
                           ...
                           :class="{
                              'text-white': chat.id === $page.props.id,
                           }"
                        >
                           {{ chat.user.name }}
                        </div>
      ...
      <div class="bg-secondary/10" :class="isOpen ? 'max-md:hidden md:mr-[200px] lg:mr-[250px] xl:mr-[350px]' : ''">
         ...
         <div class="w-full p-4 pt-0" style="position: sticky; bottom: 0">
            <form @submit.prevent="sendMessage" class="relative -mt-2">
               ...
               <button type="submit" class="absolute right-2 top-2 btn btn-secondary btn-circle btn-sm">
               ...
               <div v-if="attachmentPreview.value" class="indicator absolute left-2 bottom-12">
                  <button @click="removeAttachment" class="indicator-item badge badge-error w-6 h-6">
